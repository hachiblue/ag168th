<div id="content" ng-app="mowner-app">
    <div ng-view=""></div>
</div>
...
<link rel="stylesheet" href="<?php echo \Main\Helper\URL::absolute('/public/app/mowner/layout.css'); ?>">
...
<script src="<?php echo \Main\Helper\URL::absolute('/public/app/mowner/app.js'); ?>"></script>